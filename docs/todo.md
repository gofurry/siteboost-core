...
- Finish DNSIntercept manual high-port smoke for the v0.7.1-dev path.
- Finish real Windows smoke for the v0.7.1-dev provider registry and Hosts/AppHost path.
- Decide whether v0.7.2 should implement explicit system DNS takeover before Page Enhance.
...
- Evaluate Page Enhance and explicit system DNS takeover as staged pre-extraction capabilities; keep VPN/TUN deferred to mature external adapters.
...
- DNSIntercept manual is implemented. System DNS takeover, VPN / TUN, and JS injection/page enhancement remain staged work; VPN/TUN is deferred to external adapters.
