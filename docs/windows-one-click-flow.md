...
This document records the Windows system-change boundary introduced in v0.6.4 and still used by the v0.7.4-dev provider, DNSIntercept, and Page Enhance architecture.
