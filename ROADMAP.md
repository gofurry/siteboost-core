...
> 状态日期：2026-06-17  
> 主维护语言：中文  
> 当前阶段：v0.2.0 Resolver / DoH / 上游代理已实现，等待后续打磨与发布
...
- 继续用补丁版本打磨 v0.2.0 的 resolver、upstream 与 ProxyOnly 集成路径。
- 补充 malformed request、dial failure、upstream failure 等边界测试。
- 保持 CI 和文档同步更新。
