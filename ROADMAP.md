...
> 状态日期：2026-06-17  
> 主维护语言：中文  
> 当前阶段：v0.3.0 PAC 与 System Proxy 已实现，等待后续打磨与发布
...
- 继续用补丁版本打磨 v0.3.0 的 PAC/System Proxy 与 restore 路径。
- 补充真实平台 smoke 记录和系统代理边界测试。
- 保持 CI 和文档同步更新。

中期：

- 完成 Hosts / HTTPS Reverse Proxy 与 restore。
- 建立跨平台恢复策略。
