...
16. `v0.7.4`：Steam 官方 Web API outbound profile。
17. `v0.8.0`：公共 Go library 抽离准备。
18. `v1.0.0`：稳定 API 与集成发布。
